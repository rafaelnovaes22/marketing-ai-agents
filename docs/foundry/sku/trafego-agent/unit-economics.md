...
> ⚠️ **Importante:** Ad spend (budget que cliente injeta na Meta) **NÃO entra em C3**. Cliente paga ad spend separadamente direto à Meta via cartão próprio. SKU Novais Digital cobra apenas pela criação + otimização da campanha.
...
> Mixpanel é cobrado por evento ingerido no plano Novais Digital (negociado em flat-fee R$ 800/mês até 10M events). Custo amortizado por campanha = R$ 0,15 considerando ~150 campanhas/mês.
...
| **Novais Digital SKU fee** (criação + otimização) | Cliente (fatura Novais Digital) | R$ 50 por campanha publicada |
| **Custo Novais Digital por campanha** (operação interna) | Novais Digital absorve | R$ 6,50 |
...
→ `/novais-digital:plan trafego-agent`
...
→ Pre-flight integração: solicitar acesso Meta Business Manager Novais Digital + Mixpanel project
