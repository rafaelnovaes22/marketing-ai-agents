...
diagnose_command: "/novais-digital:diagnose video-editor-agent"
...
**Cabe no ICP?** ✅ Sim — Novais Digital Social posicionado como SaaS² para founders B2B/B2C com presença em vídeo recorrente. Video-editor é P1 porque depende do P0 (social-media-agent) já estar operando para distribuir os clips.
...
- **Single-tenant fase 1** (C8): Novais Digital própria como cliente único.
...
→ `/novais-digital:spec --type=platform-sku video-editor-agent`
