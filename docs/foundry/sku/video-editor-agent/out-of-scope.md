...
> ⚠️ Este documento registra o **diferimento explícito** do SKU `video-editor-agent-premium` (R$ 150 — Cenário B Veo 3 from-scratch) para wave 2 do consumer Novais Digital Social.
>
> **Não criar arquivos `docs/foundry/sku/video-editor-agent-premium/` nesta wave.**
...
- ICP Novais Digital Social é founders que já produzem vídeo (palestras, lives, podcasts)
...
1. ❌ NÃO criar arquivos em `docs/foundry/sku/video-editor-agent-premium/`
...
- **Pre-merge check** (`/novais-digital:pre-merge-check`): incluir verificação no-veo3
...
**Versão pública:**
> "Novais Digital Social Video Editor (R$ 30) edita seus vídeos longos em clips prontos para todas as redes. Geração de vídeo do zero via IA está em nosso roadmap para 2026 H2 — entre em contato se precisar antecipadamente."
