...
**`shadow`** (desde 2026-05-19) — **primeiro SHADOW do projeto Novais Digital Social.** Subscription `novais-digital-internal-copywriter-001` em produção interna (Novais Digital própria como cliente piloto). Billing desativado. Janela mínima: 14 dias hard floor C4 → SHADOW→ASSISTED elegível em 2026-06-02.

## Histórico de transições

| Stage | Data | Aprovador | Gates aprovados | Notas |
|-------|------|-----------|-----------------|-------|
| `(new)` → `draft` | 2026-05-13 | @po-guardian (pending review) | Diagnose preliminar + spec + unit-economics (APPROVED) + plan (APPROVED) | Segundo SKU do Novais Digital Social. Reusa stack do social-media-agent (langfuse, claude-adapter base, voice loader). |
...
**Comando para transição:** `/novais-digital:promote copywriter-agent --to=shadow`
...
**Comando:** `/novais-digital:promote copywriter-agent --to=assisted`

**Pré-requisito adicional:** `/novais-digital:sla-threshold copywriter-agent` define SLA contratual.
...
- Cliente piloto (Novais Digital própria) endossa qualidade nos 3 tipos
...
- `/novais-digital:promote copywriter-agent --to=shadow` (de ASSISTED ou AUTONOMOUS)
- `/novais-digital:promote copywriter-agent --to=draft` (de SHADOW)
