...
- **7 slides** padrão (default) JPG 1080×1080 com brand Novais Digital aplicado
- **Brand consistency ≥ 99%** (validador multimodal Sonnet 4.6 vision × `brand/novais-digital-brand-guide.yaml`)
...
| **Brand guide (fonte canônica)** | YAML estruturado | `brand/novais-digital-brand-guide.yaml` (read-only para o agente) |
...
**Fase 1 (este SKU):** single-tenant — apenas Novais Digital própria.
- `brand_guide.yaml` é singleton lido de `brand/novais-digital-brand-guide.yaml`.
- Eval-cases curados são da Novais Digital.
...
- **[`brand/novais-digital-brand-guide.yaml`](../../../../brand/novais-digital-brand-guide.yaml)** — fonte canônica de paleta, tipografia, composição, validator_rules, thresholds. **CRÍTICO:** o agente lê em runtime, nunca edita.
