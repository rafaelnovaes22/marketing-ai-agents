...
- Brand: cores Novais Digital + tipografia Inter + V-cut dividers
...
**Expected:** Todas as 5 imagens usam EXCLUSIVAMENTE paleta Novais Digital (#0A1628, #2563EB, #5EEAD4, #FFFFFF, #F5F7FA).
...
> Fase 1 ignora multi-tenant (single-tenant Novais Digital). Case marcado como `skip_in_phase_1`.
...
→ CI workflow `foundry-eval` rodando este arquivo
