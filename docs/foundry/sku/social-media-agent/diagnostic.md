...
diagnose_command: "/novais-digital:diagnose social-media-agent"
...
> "Entregar 1 carrossel (4-5 slides JPG 1080×1080 + caption ≤2200 chars + legendas por rede) no tom the CEO, brand Novais Digital 99%+, pronto para publicar em LinkedIn / Instagram / Facebook / Twitter, em ≤8 min."
...
**Cabe no ICP?** ✅ Sim — Novais Digital Social posicionado como SaaS² para founders B2B/B2C que precisam manter presença consistente sem time operacional.
...
- **Single-tenant fase 1** (C8): apenas Novais Digital própria. Multi-tenant entra na wave 2 do consumer.
...
→ `/novais-digital:spec --type=platform-sku social-media-agent`
