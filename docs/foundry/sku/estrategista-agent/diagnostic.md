...
diagnose_command: "/novais-digital:diagnose estrategista-agent"
...
- **Single-tenant fase 1** (C8): apenas Novais Digital própria como cliente piloto.
...
→ `/novais-digital:spec --type=platform-sku estrategista-agent`
