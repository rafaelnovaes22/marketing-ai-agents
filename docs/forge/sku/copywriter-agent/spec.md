...
1. Tipo A — "Landing para curso Acme Forge, público founders B2B, framework PAS, tom CEO"
...
**Fase 1 (este SKU):** single-tenant — Acme própria como cliente único. Voice exemplars = the CEO.
