...
SHADOW (interno Acme, ≥30 dias — mais longo que B)
...
**Fase 1 (este SKU):** single-tenant (Acme própria), mas **já desenhado multi-tenant-ready** porque é o primeiro SKU vendido como SaaS na wave 2.
