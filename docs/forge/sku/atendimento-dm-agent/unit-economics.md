...
- **Mitigação:** ADR-003-DM hard cap em 25 turnos com escalonamento obrigatório. Conversas que chegam ao cap não cobram (custaram para Acme mas não geram receita). Frequência esperada: <2% das conversas.
...
- Acme absorve esse custo como "custo de qualidade" — esperado em ≤15% das conversas.

## 7. Análise de volume e P&L mensal

Premissas Acme própria (single-tenant fase 1):
...
→ `/acme:plan atendimento-dm-agent`
