...
6. [ ] Opt-in form criado e assinado por 100% staff Acme participante
7. [ ] Disclaimer LGPD ativo em 100% das conversas

**Restrições adicionais (ADR-004-DM):**
- ✅ Dados processados: APENAS DMs internos Acme (staff opt-in)
...
**Comando para entrar em SHADOW interno:** `/acme:promote atendimento-dm-agent --to=shadow_internal`
...
- [ ] Política de privacidade publicada (Acme + por tenant)
...
**Compromisso de não-cobrança:** se houver escalonamento humano necessário, Acme absorve custo (não cobra do cliente).
