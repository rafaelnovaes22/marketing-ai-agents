...
SHADOW (semana 15, ~D1-D5)
  • 30+ diagnósticos rodados em tenants piloto (incluindo Acme própria)
...
- Infrastructure testado com integração real (Mixpanel sandbox + tenant fake Acme)
- **Eval suite** com 30 cenários curados (15 funis reais anonimizados + 15 sintéticos) — gate de promoção SHADOW → ASSISTED

## 7. Tenant context (C8)

**Fase 1 (este SKU):** single-tenant — Acme própria como piloto.
